"""Privacy-safe Sentry initialization for API and worker processes."""
...
def init_sentry(
    ...
    *,
    ...
    Returns whether Sentry is ready to capture events. Missing DSNs are treated
    as disabled so local and PR builds do not need secrets.
    """
    ...
    sentry_sdk.set_tag("app", "playbook")
